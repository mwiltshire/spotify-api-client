export const savedAlbumsOffset0Limit1 = {
...
export const savedAlbumsOffset1Limit1 = {
  href: 'https://api.spotify.com/v1/me/albums?offset=1&limit=1',
  items: [
    {
      added_at: '2015-11-26T19:13:31Z',
      album: {
  ...
  next: null,
  offset: 0,
  previous: 'https://api.spotify.com/v1/me/albums?offset=0&limit=1',
  total: 2
};
